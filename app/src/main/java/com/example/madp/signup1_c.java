...
public class signup1_c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.signup1_activity_c);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(full_name) || TextUtils.isEmpty(Address) || TextUtils.isEmpty(Contact) || TextUtils.isEmpty(e_mail)){
                    Toast.makeText(signup1_c.this,"All Fields Required", Toast.LENGTH_SHORT).show();
                } else {

                    Intent intent = new Intent(getApplicationContext(), signup3_c.class);
