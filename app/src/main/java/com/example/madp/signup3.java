        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(user_name) || TextUtils.isEmpty(passWord) || TextUtils.isEmpty(r_passWord)){
                    Toast.makeText(signup3.this,"All Fields Required", Toast.LENGTH_SHORT).show();
                } else {
                    Boolean insert = loginHelper.insertUsers(full_name, Address, Contact, e_mail, user_name, passWord);
                    if (insert){
                        Intent intent = new Intent(getApplicationContext(),login_activity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(signup3.this,"Registration Failed!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
